...
<div class="container mt-5">
    <h2 class="mb-4">Formulário Base</h2>
    <form action="processa_post.php" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="idade" name="idade" placeholder="Digite sua idade" min="1" required> 
        </div>
